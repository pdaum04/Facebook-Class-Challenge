...
class FacebookProfile {
    ...
    let birthday = "August 3rd 1992"
    var relationshipStatus = "Married to @JoshKushner"
    var friendsList = ["Jimmy Fallon",
                       "Joan Smalls",
                       "Joshua Kushner",
                       "Serena Williams",
                       "Taylor Swift"
...
} //Closing bracket for the FBook profile class

//Test Iterations Here
//Iteration 0 Test
var karlie = FacebookProfile()//create object as __lldb_expr_9.FacebookProfile
print(karlie)
//Iteration 1 Test
